...
def nuevaVentana3():
    ...
    def boton():
        ...
        TercerVentana.geometry("800x500")
        variable= EntradaDeText.get()
        TercerVentana.config(bg="#00BFBF")
        TercerVentana.title("Palabras Clave")
        TercerVentana.iconbitmap("Logo.ico")
        miLabelPrueba2 = Label(TercerVentana, text="Felicidades!, se han encontrado tus palabras:", fg="#000000",bg = "#00BFBF",font=("DejaVuSansMono-Bold",10))
        miLabelPrueba2.grid(row = 1, column = 1, pady=10)
        miLabelPrueba = Label(TercerVentana, text="Mexico, government, actions, results, September 2020 - June 2021, politics, government, corruption, rule of law, crime rates, ", fg="#FFFFFF",bg = "#00BFBF",font=("DejaVuSansMono-Bold",10))
        miLabelPrueba.grid(row = 2, column = 1, pady=10)
        miLabelPrueba3 = Label(TercerVentana, text="democracy, public participation, social policy, well-being, pension programs, education, healthcare, cultural promotion, economy,", fg="#FFFFFF",bg = "#00BFBF",font=("DejaVuSansMono-Bold",10))
        miLabelPrueba3.grid(row = 3, column = 1, pady=10)
        miLabelPrueba3 = Label(TercerVentana, text="economic growth, fiscal stability, tax collection, private investment, energy sector, equality, human rights, COVID-19 response, ", fg="#FFFFFF",bg = "#00BFBF",font=("DejaVuSansMono-Bold",10))
        miLabelPrueba3.grid(row = 4, column = 1, pady=10)
        miLabelPrueba3 = Label(TercerVentana, text="education, inclusive education, scholarships, cultural sector, economic recovery, energy sector, well-being, gender equality, social ", fg="#FFFFFF",bg = "#00BFBF",font=("DejaVuSansMono-Bold",10))
        miLabelPrueba3.grid(row = 5, column = 1, pady=10)
        miLabelPrueba3 = Label(TercerVentana, text="mobility, procurement processes, transparency, ethics, accountability, citizen participation, gender equality, electronic systems, ", fg="#FFFFFF",bg = "#00BFBF",font=("DejaVuSansMono-Bold",10))
        miLabelPrueba3.grid(row = 6, column = 1, pady=10)
        miLabelPrueba3 = Label(TercerVentana, text="consolidated purchases, legislative reforms, rule of law, corruption eradication, security strengthening, social welfare, human rights, ", fg="#FFFFFF",bg = "#00BFBF",font=("DejaVuSansMono-Bold",10))
        miLabelPrueba3.grid(row = 7, column = 1, pady=10)
        miLabelPrueba3 = Label(TercerVentana, text=" drug addiction, peace promotion, prison improvements, security intelligence, international cooperation, civil protection, disaster prevention, ", fg="#FFFFFF",bg = "#00BFBF",font=("DejaVuSansMono-Bold",10))
        miLabelPrueba3.grid(row = 8, column = 1, pady=10)
        miLabelPrueba3 = Label(TercerVentana, text="risk management, National Guard, crime reduction, police professionalism, women's participation, violence prevention, reconstruction", fg="#FFFFFF",bg = "#00BFBF",font=("DejaVuSansMono-Bold",10))
        miLabelPrueba3.grid(row = 9, column = 1, pady=10)
...
miLabel = Label(miFrame, text="HermesAI",fg="#FFFFFF",bg = "#800080",font=("DejaVuSansMono-Bold",20))
